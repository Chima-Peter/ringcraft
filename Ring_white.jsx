...
Command: npx gltfjsx@6.5.3 .\public\ring_white.glb 
*/

import React from 'react'
import { useEffect } from 'react'
import { useGLTF } from '@react-three/drei'
import { useColorContext } from './src/colorContext'

export function Model(props) {
  const { nodes, materials } = useGLTF('/ring_white.glb')

  const { outerColor, innerColor } = useColorContext()
  ...
  useEffect(() => {
    ...
    materials['335_Mystic_Black_Pearl'].color.set(outerColor) // Black color

    // Change the color of item02 material
    materials['001_718_Crystal_Red_Coral_Pearl'].color.set(innerColor) // Green color
